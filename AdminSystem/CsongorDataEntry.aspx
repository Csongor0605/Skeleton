...
<body>
    <form id="form1" runat="server">
        <div style="height: 772px">
            ...
            <br />
            <br />
            <asp:Label ID="Login" runat="server" Text="Login ID" width="79px"></asp:Label><asp:TextBox ID="LoginIDBox" style="z-index: 1; left: 169px; top: 59px; position: absolute" runat="server"></asp:TextBox>
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Find" style="position: absolute"/>
            <br />
            <br />
            <asp:Label ID="Email" runat="server" Text="Email" width="138px"></asp:Label><asp:TextBox ID="EmailTextBox" runat="server" style="z-index: 1; left: 169px; top: 101px; position: absolute;" OnTextChanged="EmailTextBox_TextChanged"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Password" runat="server" Text="Password" width="138px"></asp:Label><asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 169px; top: 145px; position: absolute;"></asp:TextBox>
            <br />
            <br />
